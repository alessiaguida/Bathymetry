...
load(".\seabedFunctions\missionData\vettore_risultante_entrambi_senza_errore.mat");
vettore_risultante = vec_risultante_totale;
%scaling mission data
z_auv = 0;
%z_base = 300;
vettore_risultante(3, :) = z_auv + vettore_risultante(3, :);
